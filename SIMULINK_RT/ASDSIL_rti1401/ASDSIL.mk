...
#
#  $RCSfile: ASDSIL.mk $ $Revision: 2.45 $ $Date: 2010/06/17 13:38:04CEST $
#  $ProjectName: e:/ARC/Products/ImplSW/RTISW/RTI/Distribution/MATLAB/RTI1401/M/project.pj $
# =============================================================================
...
MATLAB_ROOT                    = C:\Matlab2010b\R2010bSP1
MATLAB_BIN                     = C:\Matlab2010b\R2010bSP1\bin
MATLAB_ROOT_ALT                = C:\Matlab2010b\R2010bSP1
MATLAB_BIN_ALT                 = C:\Matlab2010b\R2010bSP1\bin
RELEASE_VERSION                = R2010bSP11
RELEASE_VERSION               := $(RELEASE_VERSION,S'\.'_',W_,LC,S'^r'')
COMPUTER                       = PCWIN
MODEL                          = ASDSIL
MODULES                        = ASDSIL_data.c ASDSIL_trc_ptr.c rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c 
S_FUNCTIONS                    = ds1401dac_t1.c ds1401dio_t1_bit_out.c
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 2
TID01EQ                        = 0
...
#
MSG_OPTS = -nQi -QmsC0001 -Qms0111 -QmsC0177 -QmsC0186 -QmsC0188 -QmsC0191 -QmsC0193 -QmwC0223 -QmeC0233 -QmsC0236 -QmsC0237 -QmwC0260 -QmsC0340 -QmsC0381 -QmsC0514 -Qms0550 -QmsC0826 -Wa,-QmsA0736 -Qms1430 -Qms1457
...
LNK_OPTS = -QmsA0314 -QmsA0407 -QmeA0307 -QmeA0329
...
TMP_PATH_CC += $(MATLAB_ROOT)\rtw\c\src
TMP_PATH_CC += C:\dSPACE\MATLAB\RTICAN\TLC
TMP_PATH_CC += C:\dSPACE\MATLAB\RTI1401\SFcn
